    ...
    <div class="relative min-h-screen bg-white shadow-2xl transition-colors duration-200 dark:bg-background-dark overflow-hidden flex flex-col">
        ...
        <main class="flex-1 flex flex-col items-center justify-center px-6 relative z-10 w-full py-10">
            <div class="mb-8 relative">
                <div class="w-24 h-24 rounded-full bg-green-100 dark:bg-green-900/20 flex items-center justify-center animate-pulse">
                ...
                <div class="absolute top-0 -right-2 w-3 h-3 bg-primary rounded-full opacity-60"></div>
                <div class="absolute bottom-2 -left-2 w-2 h-2 bg-orange-400 rounded-full opacity-60"></div>
                <div class="absolute -top-2 left-4 w-2 h-2 bg-blue-400 rounded-full opacity-60"></div>
            </div>

            <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2 text-center">Pembayaran Berhasil!</h1>
            <p class="text-secondary-text text-center mb-10 max-w-[280px] leading-relaxed">
                Terima kasih! Pesanan Anda telah dikonfirmasi dan sedang disiapkan.
            </p>
            ...
            <div class="w-full bg-white dark:bg-card-dark rounded-3xl p-6 shadow-xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800 relative overflow-hidden">
                ...
                <div class="text-center mb-6 pt-2">
                    <p class="text-xs font-bold text-secondary-text uppercase tracking-widest mb-1">Total Bayar</p>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-between items-center text-sm">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span class="font-semibold text-gray-900 dark:text-white">{{ $transaction->payment_method ?? 'Payment' }}</span>
                        </div>
                    </div>
                </div>
                <!-- Card Punch Holes -->
        ...
        <div class="p-6 pb-24 bg-white dark:bg-background-dark relative z-20">
            <div class="flex flex-col gap-3">
                @if($transaction)
                <a href="{{ route('order.track', $transaction->invoice_number) }}" class="w-full h-14 rounded-xl bg-primary text-white flex items-center justify-center shadow-lg shadow-primary/30 hover:bg-red-700 active:scale-95 transition-all group">
                    <span class="material-icons mr-2 text-white/90">local_shipping</span>
                    <span class="text-base font-bold">Lacak Pesanan</span>
                </a>
                @endif
